...
print()
for x in range(0,11):
 os.chdir(r"C:\Users\D-Flow\Desktop\BA\Analyzer Measurement\Measurment3\30 percentage")
 folder = os.listdir()
 os.chdir(folder[x])
...
print("%30 Utilization")
print("\\begin{figure}[htbp] ")
print("\\begin{tabular}{cc}")
print("\\subfigure[Measurement with 30\\% Utilization]{")
print("\\resizebox{0.5\\textwidth}{!}{")
...
print("    	{",fin_list[6*2],"};")
print(" \legend{Boxplot,Theory,Median}")
print("\\end{axis}")
