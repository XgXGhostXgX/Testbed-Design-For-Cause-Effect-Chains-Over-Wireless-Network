...
print()
for x in range(0,11):
 os.chdir(r"C:\Users\D-Flow\Desktop\BA\Analyzer Measurement\Measurment3\50 percentage")
 folder = os.listdir()
 os.chdir(folder[x])
...
print("%50 Utilization")
print("\\subfigure[Measurement with 50\\% Utilization]{")
