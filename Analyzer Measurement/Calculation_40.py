...
print()
for x in range(0,11):
 os.chdir(r"C:\Users\D-Flow\Desktop\BA\Analyzer Measurement\Measurment3\40 percentage")
 folder = os.listdir()
 os.chdir(folder[x])
...
print("%40 Utilization")
print("\\subfigure[Measurement with 40\\% Utilization]{")
